...
if(message.content.startsWith(prefix+"kick") || message.content.startsWith(prefix+"Kick") || message.content.startsWith(prefix+"KICK")) { 
 ...
 timestamp: new Date(),
  ...
  text: 'Kick Command'
    ...
    let embed = new Discord.RichEmbed()
    .setColor('RANDOM')
    .setDescription("**:robot:Si tu veut m'invité sur ton serveur voici mon liens: [Click here](https://discordapp.com/api/oauth2/autho<rize?client_id=539901046689103872&permissions=8&scope=bot)**\n\n**Join My Discord if you need to help :zap:\n===================================================\n\n:smile:-Best Support \n:crossed_swords:- Good staff's\n\n===================================================\n\n- :link: Serveur Support du bot :link: -\nhttps://discord.gg/GtUVkvC**")
